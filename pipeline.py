...
def write_embeddings(embedding: Dict):
    ...
    # Name of the index
    index_name = "data_classification_rules"
...
@dsl.pipeline(
    name="data-class-knowledge-base-model12",
)
...
compiler.Compiler().compile(technology_papers_and_reports, 'data-class-knowledge-base-model12.json')
